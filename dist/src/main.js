...
var PublicClientApplicationExtended_1 = require("./PublicClientApplicationExtended");
var MSAL = /** @class */ (function () {
    function MSAL(options) {
        ...
        this.lib = new PublicClientApplicationExtended_1.PublicClientApplicationExtended({
            auth: {
    ...
    MSAL.prototype.initialize = function (resolve) {
        return __awaiter(this, void 0, void 0, function () {
            var _getClientConfiguration_1;
            var _this = this;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.auth.authorityTokenEndpointOverride) {
                            _getClientConfiguration_1 = this.lib.getClientConfiguration;
                            this.lib.getClientConfiguration = function (requestAuthority) { return __awaiter(_this, void 0, void 0, function () {
                                var configuration;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, _getClientConfiguration_1.bind(this.lib)(requestAuthority)];
                                        case 1:
                        ...
                        return [4 /*yield*/, this.lib.handleRedirectPromise().then(function (error, response) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!!this.isAuthenticatedNow()) return [3 /*break*/, 1];
                                            this.saveCallback('auth.onAuthentication', error, response);
                                            return [3 /*break*/, 3];
                                        case 1: return [4 /*yield*/, this.acquireToken()];
                                        case 2:
                                            _a.sent();
                                            _a.label = 3;
                    ...
                    case 1:
                        _a.sent();
                        if (!this.auth.requireAuthOnInitialize) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.signInNow()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        this.data.isAuthenticated = this.isAuthenticatedNow();
                        if (!this.data.isAuthenticated) return [3 /*break*/, 5];
                        // FIXME: in MSAL 2.x there may be multiple accounts...
                        this.data.user = this.lib.getAllAccounts()[0];
                        return [4 /*yield*/, this.acquireToken().then(function () {
    ...
    MSAL.prototype.signInNow = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(!this.lib.isCallback(window.location.hash) && (!this.lib.getAllAccounts() || this.lib.getAllAccounts().length == 0) && !this.lib.interactionInProgress())) return [3 /*break*/, 2];
                        // request can be used for login or token request, however in more complex situations this can have diverging options
                        return [4 /*yield*/, this.lib.loginRedirect(this.request)];
                    case 1:
                        // request can be used for login or token request, however in more complex situations this can have diverging options
                        _a.sent();
                        _a.label = 2;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!this.options.auth.beforeSignOut) return [3 /*break*/, 3];
                    ...
                    case 3:
                        if (this.isAuthenticatedNow()) {
                            accounts = this.lib.getAllAccounts();
                            this.lib.logout({
                                'account': accounts[0]
                            });
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.isAuthenticatedNow()];
                }
            });
        });
    };
    MSAL.prototype.isAuthenticatedNow = function () {
        var accounts = this.lib.getAllAccounts();
    ...
    MSAL.prototype.handleTokenResponse = function (error, response) {
        ...
        if (this.data.idToken !== response.idToken.rawIdToken) {
            this.setToken('idToken', response.idToken, new Date(response.idTokenClaims.exp * 1000), [this.auth.clientId]);
